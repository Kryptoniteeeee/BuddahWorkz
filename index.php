...
<li class="active" ><a rel="tooltip"  data-placement="bottom" title="Home" id="home" href="index.php" class=""><i class="icon-home icon-large"></i>&nbsp;Home</a></li>
						...
						<li><a rel="tooltip"  data-placement="bottom" title="Contact Us" class=""><i class="icon-phone icon-large"></i>&nbsp;Contact US</a></li>
										<ul>
...
◾ Torsion Controller</p>
			...
			<!-- Three -->
				<section id="three" class="spotlight style3 left">
					...
					<div class="content">
						<h4 style="color:#4DE8A4;"></style>Proceed Login to Make a Reservartion Now </h4>

<li><a href="login.php" class="button primary" title="Click Here to Login" id="login">Login</a></li>
							<p><a rel="tooltip"  data-placement="bottom" title="Click Here to Sign UP" id="signup" href="signup.php"> <br>Not a Member? Sign Up Now</a></p>
